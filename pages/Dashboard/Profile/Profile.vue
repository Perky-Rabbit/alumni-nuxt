      ...
      <main class="col col-xl-9 order-xl-2 col-lg-12 order-lg-1 col-md-12 col-sm-12 col-12">
        ...
        <div class="bg-white mb-3">
          <div v-if="background_image_url" class="py-4 px-3 border-bottom circular" style="height: 150px;" :style="{ backgroundImage: 'url(' + background_image_url + ')' }">
            <button type="button" class="btn btn-light btn-sm float-right rounded-circle" @click="backgroundImageChange(background_image_url, alumni)">
              <i class="fa-light fa fa-pencil"></i>
            </button>
            <a href="#" @click="profileImage(profile_image_url, alumni)">
        ...
        <div class="box shadow-sm rounded bg-white mb-3">
          ...
          <div class="box-body p-2 div-footer-show-all">
            <div class="text-center">
              <router-link :to="{ name: 'skills' }"><b>Show All {{ skills.length }} skills <i class="fa-solid fa-arrow-right"></i></b></router-link>
            </div>
          </div>
        </div>
        ...
        <div class="box shadow-sm rounded bg-white mb-3">
          ...
          <div class="box-body p-2 div-footer-show-all">
            <div class="text-center">
              <router-link :to="{ name: 'achievements' }"><b>Show All {{ achievements.length }} achievements <i class="fa-solid fa-arrow-right"></i></b></router-link>
            </div>
          </div>
        </div>
      </main>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input v-model="basicInfoForm.dob" type="text" name="dob" class="form-control" placeholder="Enter date of Birth">
                </div>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <div class="form-group">
                    <label for="contact_number" class="mb-0">Contact Number</label>
                    <input v-model="contactInfoForm.contact_number" type="text" name="contact_number" class="form-control" placeholder="Enter Contact Number">
                </div>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input v-model="educationForm.start_date" type="text" name="start_date" class="form-control" placeholder="Ex: 20-10-1970">
                </div>

                <div class="form-group">
                    <label for="end_date" class="mb-0">End date</label>
                    <input v-model="educationForm.end_date" :disabled="educationForm.is_current == 'Yes'" type="text" name="end_date" class="form-control" placeholder="Ex: 20-10-1970">
                </div>
          ...
          <div class="modal-dialog modal-dialog-scrollable modal-lg" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <div class="form-group">
                    <label for="start_date" class="mb-0">Start date</label>
                    <input v-model="experienceForm.start_date" type="text" name="start_date" class="form-control" placeholder="Ex: 20-10-1970">
                </div>

                <div class="form-group">
                    <label for="end_date" class="mb-0">End date</label>
                    <input v-model="experienceForm.end_date" :disabled="experienceForm.is_current == 'Yes'" type="text" name="end_date" class="form-control" placeholder="Ex: 20-10-1970">
                </div>
